...
export function AppShell({ profile, children, onLogout, onAvatarChange, onPasswordChange, onMeetOzzie = () => {}, currentView = 'navigator', onNavigate = () => {}, onOpenReadinessResource = () => {}, onFeedback, reportContext = {} }) {
